...
#    poll: "Poll" # Tooltip on poll button from /play
  ...
  share_progress_modal:
    blurb: "Você está fazendo um grande progresso! Diga a alguém o quanto você aprendeu com o CodeCombat."
...
#    leaderboard: "Leaderboard"
  ...
  subscribe:
    ...
    personal_sub: "Inscrição Particular" # Accounts Subscription View below
    loading_info: "Carreando as informações da inscrição..."
    managed_by: "Administrado por"
    will_be_cancelled: "Será cancelada em"
    currently_free: "Atualmente você possui uma inscrição gratuita"
    currently_free_until: "Atualmente você possui uma inscrição gratuita até"
    was_free_until: "Você teve uma inscrição gratuita até"
    managed_subs: "Administrar Assinaturas"
    managed_subs_desc: "Adicione inscrições para outros jogadores (alunos, crianças e etc)."
    group_discounts: "Descontos em grupo"
    group_discounts_1st: "Primeira Inscrição (Inclusive a sua)"
    group_discounts_full: "Preço sem desconto"
    group_discounts_2nd: "Inscrições 2-11" #You need to specify what 2-11 mean (date?).
    group_discounts_20: "20% de desconto"
    group_discounts_12th: "Inscrições 12+"
    group_discounts_40: "40% de desconto"
    subscribing: "Assinando..."
    recipient_emails_placeholder: "Insira o endereço de email para a inscrição, um por linha."
    subscribe_users: "Inscrever usuários"
    users_subscribed: "Usuários inscritos:"
    no_users_subscribed: "No users subscribed, please double check your email addresses."
    current_recipients: "Beneficiados atuais"
